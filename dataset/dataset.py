...
#
# отчёт
# постановка - распознавание объектов
# сделали штуку - распознаёт, позволяет подъезжать
# комплекс управления на базе обучения с подкреплением
# трекинг
# объекты получали награду
# 3 страницы - введение, постановка задачи
# 3 страницы - выводы из литературы
# 5 что делали, распознавания, составная часть системы обучения с подкреплением
# появился, не появился, куда двигаться
#
# публикация в скопус у магистрантов
#
